...
import com.github.copyinaction.service.PerformanceService
...
class PerformanceController(
    ...
    @ApiResponses(
        ...
        ApiResponse(responseCode = "404", description = "공연을 찾을 수 없음", content = [Content(schema = Schema(implementation = ErrorResponse::class))])
    )
    @GetMapping("/{id}")
