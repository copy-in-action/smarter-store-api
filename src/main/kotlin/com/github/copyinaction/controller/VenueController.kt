...
import com.github.copyinaction.service.VenueService
...
@Tag(name = "venues", description = "공연장 API - 공연장 관련 CRUD를 처리하는 API")
@RestController
...
class VenueController(
    ...
    @ApiResponses(
        ...
        ApiResponse(responseCode = "400", description = "잘못된 입력 값", content = [Content(schema = Schema(implementation = ErrorResponse::class))]),
    ...
    @ApiResponses(
        ...
        ApiResponse(responseCode = "404", description = "공연장을 찾을 수 없음", content = [Content(schema = Schema(implementation = ErrorResponse::class))])
    )
