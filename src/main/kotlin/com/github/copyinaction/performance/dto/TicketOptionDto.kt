...
data class TicketOptionResponse(
    ...
    @Schema(description = "티켓 가격", example = "120000.00")
    val price: BigDecimal,

    @Schema(description = "티켓 총 수량", example = "100")
    val totalQuantity: Int?,

    @Schema(description = "티켓 옵션 정보 생성일시", example = "2023-01-01T12:00:00")
    val createdAt: LocalDateTime?,

    @Schema(description = "티켓 옵션 정보 수정일시", example = "2023-01-01T12:00:00")
...
data class CreateTicketOptionRequest(
    @field:NotBlank
    @Schema(description = "생성할 티켓/좌석 등급명", example = "R석", required = true)
    val name: String,

    @field:Positive
    @Schema(description = "생성할 티켓 가격", example = "120000.00", required = true)
    val price: BigDecimal,

    @Schema(description = "생성할 티켓 총 수량", example = "100")
    val totalQuantity: Int?
