...
class CompanyController(
    ...
    @Operation(summary = "판매자 생성", description = "새로운 판매자 정보를 생성합니다.\n\n**권한: ADMIN**")
    @ApiResponses(
        ApiResponse(responseCode = "201", description = "판매자 생성 성공"),
        ApiResponse(
            responseCode = "400",
    ...
    @Operation(summary = "단일 판매자 조회", description = "ID로 특정 판매자 정보를 조회합니다.\n\n**권한: ADMIN**")
    @ApiResponses(
    ...
    @GetMapping("/{id}")
    fun getCompany(
        @Parameter(description = "조회할 판매자 ID", required = true, example = "1")
    ...
    @Operation(summary = "모든 판매자 조회", description = "모든 판매자 목록을 조회합니다.\n\n**권한: ADMIN**")
    @ApiResponses(
        ApiResponse(responseCode = "200", description = "판매자 목록 조회 성공")
    )
    @GetMapping
    ...
    @Operation(summary = "판매자 정보 수정", description = "특정 판매자 정보를 수정합니다.\n\n**권한: ADMIN**")
    @ApiResponses(
    ...
    @PutMapping("/{id}")
    fun updateCompany(
        @Parameter(description = "수정할 판매자 ID", required = true, example = "1")
        @PathVariable id: Long,
    ...
    @Operation(summary = "판매자 삭제", description = "특정 판매자를 삭제합니다.\n\n**권한: ADMIN**")
    @ApiResponses(
    ...
    @DeleteMapping("/{id}")
    fun deleteCompany(
        @Parameter(description = "삭제할 판매자 ID", required = true, example = "1")
        @PathVariable id: Long
    ): ResponseEntity<Unit> {
