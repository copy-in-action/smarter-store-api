...
data class PerformanceScheduleResponse(
    ...
    @Schema(description = "공연 날짜 및 시간", example = "2025-12-24T19:30:00")
    val showDatetime: LocalDateTime,

    @Schema(description = "판매 시작 시각", example = "2025-11-20T14:00:00")
...
data class CreatePerformanceScheduleRequest(
    @field:NotNull
    @Schema(description = "공연 날짜 및 시간", example = "2025-12-24T19:30:00", required = true)
    val showDatetime: LocalDateTime,
