...
data class VenueResponse(
    ...
    @Schema(description = "좌석 배치도 이미지 URL", example = "https://example.com/seating_chart.jpg")
...
data class CreateVenueRequest(
    ...
    @Schema(description = "공연장 이름", example = "올림픽공원 올림픽홀", required = true)
    val name: String,
...
data class UpdateVenueRequest(
    @field:NotBlank(message = "공연장 이름은 비워둘 수 없습니다.")
    @field:Size(max = 100, message = "공연장 이름은 100자를 초과할 수 없습니다.")
    @Schema(description = "수정할 공연장 이름", example = "새로운 공연장")
    val name: String,

    @field:Size(max = 255, message = "주소는 255자를 초과할 수 없습니다.")
    @Schema(description = "수정할 주소", example = "변경된 주소")
    val address: String?,

    @Schema(description = "수정할 좌석 배치도 이미지 URL", example = "https://example.com/new_seating_chart.jpg")
    val seatingChartUrl: String?
)
